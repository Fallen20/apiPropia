...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {//autorizacion
        httpSecurity
                ...
                .and().csrf().disable()
                .authorizeRequests()
                //.mvcMatchers("/users/register/")//esto es para los nuevos usuarios
                //    .permitAll()
                .anyRequest()//cualquier cosa
                .authenticated()//ha de estar autenticado
                .and()
                .httpBasic();
    }
